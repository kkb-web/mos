...
import {Pagination, Modal, LocaleProvider, message, Icon, Input} from 'antd';
import zh_CN from "antd/lib/locale-provider/zh_CN";
import AddText from '../../qrcode/resources/AddText';
import Ellipsis from "ant-design-pro/lib/Ellipsis";
import {addText} from "../../../api/preSaleData";
...
class Text extends React.Component{
    ...
    changeContent = (e) => {
        ...
        if (title !== '' && title.length <= 20 && e.target.value !== '' && e.target.value.length <= 600) {
            this.setState({
                disableBtn: false
            });
        } else {
    ...
    render() {
        ...
        const {changeContent, rightValue, changeText, dataSource, textData, onChangeTextPage, changeTitleStyle, page} = this.props;
        return(
            <div style={{marginTop: '-25px'}}>
                ...
                <AddText ref={this.saveFormRef} visible={this.state.visible} onCancel={this.handleCancel}
