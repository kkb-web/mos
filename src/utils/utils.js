    ...
    if (type === 'today') {
        ...
        return {
            ...
            value: [
                ...
                moment(moment(`${nextYear}-${fixedZero(nextMonth + 1)}-01 00:00:00`).valueOf() - 1000).valueOf(),
            ]
        };
    } else if (type === 'year') {
        const year = now.getFullYear();
        ...
        return {
            ...
            value: [moment(`${year}-01-01 00:00:00`).valueOf(), moment(`${year}-12-31 23:59:59`).valueOf()]
        };
    }
}
...
export const getData = (type) => {
    ...
    if (type === 'today') {
        ...
        const beginTime = now.getTime() - day * oneDay;
        return [moment(beginTime).valueOf(), moment(beginTime + (7 * oneDay - 1000)).valueOf()];
    } else if (type === 'month') {
        //获取本月
...
export const handleError = (reject,err) => {
  if(typeof reject !== 'function') throw new Error('reject is not a function')
